...
Projectile::Projectile(Vector2 p_pos, float p_radAngle, int p_horLimit, int p_verLimit)
    : m_alive(true), m_startTime(static_cast<float>(GetTime())),
      m_lifeTime(0.0f), m_position(p_pos), m_radAngle(p_radAngle),
...
Projectile::Projectile(const Projectile& other)
    : m_alive(other.m_alive), m_startTime(other.m_startTime),
      m_lifeTime(other.m_lifeTime), m_position(other.m_position),
